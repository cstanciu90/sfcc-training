...
var embroideryHelper = require('*/cartridge/scripts/helpers/embroideryHelpers');
 ...
 */
function addProductToCart(currentBasket, productId, quantity, childProducts, options, embroideryText) {
    var availableToSell;
    ...
    if (productInCart) {
        ...
        if (embroideryText) {
            // Add custom text
            embroideryHelper.setEmbroideryProductLineItem(embroideryText, productLineItem);
        }
    }
